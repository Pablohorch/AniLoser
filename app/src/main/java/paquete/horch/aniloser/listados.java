...
public class listados {
    ...
    String[] razaGato={"No lo se","Siames","Persa","RagDoll","Bengala","Sphynx","Abisinio","Azul Ruso","Burmes","Bobtail Americano","Gato Exotico","Amercian shortHair",
                        "Scottish Fold","Siberiano","Sagrado Birnamita","Ocicat","Bosque de Noruega","Tonkines","Manx","Devon Rex","Angora Turco","Savannah",
                        "Mau egipcio","Curl Americano"};
